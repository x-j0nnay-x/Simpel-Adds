...
public class NeoForgeNetworkReg {
    ...
    public static final DeferredRegister<DataComponentType<?>> DATA_COMPONENT_TYPES = DeferredRegister.create(BuiltInRegistries.DATA_COMPONENT_TYPE, SimpelAddMod.MOD_ID);
