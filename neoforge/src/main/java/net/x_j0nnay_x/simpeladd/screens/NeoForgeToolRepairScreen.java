...
public class NeoForgeToolRepairScreen extends AbstractContainerScreen<NeoForgeToolRepairMenu> {

    private static final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(SimpelAddMod.MOD_ID, "textures/screens/toolrepair_gui.png");

    public NeoForgeToolRepairScreen(NeoForgeToolRepairMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
