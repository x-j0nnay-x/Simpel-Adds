...
public class NeoForgeHarvesterScreen extends AbstractContainerScreen<NeoForgeHarvesterMenu> {
    ...
    public NeoForgeHarvesterScreen(NeoForgeHarvesterMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
