...
import net.x_j0nnay_x.simpeladd.item.xp_crystal_NeoForge;
...
public class ModItemRegNeoForge {
    ...
    public static final Supplier<Item> XPCRYSTAL = ITEMS.register(ModNames.Items.XPCRYSTAL, () -> new xp_crystal_NeoForge());
    //upgrades
