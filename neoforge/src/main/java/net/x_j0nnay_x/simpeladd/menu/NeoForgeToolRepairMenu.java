...
public class NeoForgeToolRepairMenu extends AbstractContainerMenu {

    public final NeoForgeToolRepairBlockEntity blockEntity;
    private final Level level;
    private final Container inventory;
    private final ContainerData data;

    public NeoForgeToolRepairMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public NeoForgeToolRepairMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypeNeoForge.TOOLREPAIR_MENU.get(), pContainerID);
        checkContainerSize(inv, 2);
        blockEntity = ((NeoForgeToolRepairBlockEntity) entity);
        ...
        addPlayerHotbar(inv);
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeToolRepairBlockEntity.COPPERSLOT, 88, 32) {
                @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlockRegNeoForge.TOOLREPAIR.get());
    }
