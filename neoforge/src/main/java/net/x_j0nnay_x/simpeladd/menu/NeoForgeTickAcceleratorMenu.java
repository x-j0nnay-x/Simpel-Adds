...
public class NeoForgeTickAcceleratorMenu extends AbstractContainerMenu {

    public final NeoForgeTickAcceleratorBlockEntity blockEntity;
    private final Level level;
    private final Container inventory;
    private final ContainerData data;

    public NeoForgeTickAcceleratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(6));
    }

    public NeoForgeTickAcceleratorMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypeNeoForge.TICK_ACCELERATOR_MENU.get(), pContainerID);
        checkContainerSize(inv, 3);
        blockEntity = ((NeoForgeTickAcceleratorBlockEntity) entity);
        ...
        addPlayerHotbar(inv);
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeTickAcceleratorBlockEntity.COPPERSLOT, 79, 30) {
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(Items.COPPER_INGOT);
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeTickAcceleratorBlockEntity.SPEEDSLOT, 89, 11) {
                @Override
                public boolean mayPlace(ItemStack stack) {
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeTickAcceleratorBlockEntity.EFFICIENCYSLOT, 69, 12) {
                @Override
                public boolean mayPlace(ItemStack stack) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlockRegNeoForge.TICK_ACCELERATOR.get());
    }
