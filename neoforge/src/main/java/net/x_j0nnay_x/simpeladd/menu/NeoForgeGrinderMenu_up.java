...
public class NeoForgeGrinderMenu_up extends AbstractContainerMenu {
    ...
    public NeoForgeGrinderMenu_up(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        blockEntity = ((NeoForgeGrinderBlockEntity_Up) entity);
        ...
        addPlayerHotbar(inv);
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeGrinderBlockEntity_Up.OUTPUTSLOT2, 61, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeGrinderBlockEntity_Up.OUTPUTSLOT3, 79, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeGrinderBlockEntity_Up.OUTPUTSLOT4, 97, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeGrinderBlockEntity_Up.BOOSTSLOT, 124, 13){
                @Override
