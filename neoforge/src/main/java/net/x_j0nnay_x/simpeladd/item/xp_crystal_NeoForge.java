...
public class xp_crystal_NeoForge extends Item {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean isSelected) {
        if(stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()) != null) {
            if (stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()).floatValue() >= 1.0f) {
                levelUP(stack);
            }
        }
    ...
    private void  addLevel(ItemStack itemStack, Player player){
        if(itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()) != null){
            itemStack.set(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get(), itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()).intValue() + player.experienceLevel);
            player.giveExperienceLevels(-player.experienceLevel);
        }else {
            itemStack.set(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get(), player.experienceLevel);
            player.giveExperienceLevels(-player.experienceLevel);
        }
    }
    ...
    private void addProgress(ItemStack itemStack, Player player){
        if(itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()) != null){
            ...
            itemStack.set(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get(), player.experienceProgress);
            player.experienceProgress = 0;
        }
    }

    private void levelUP(ItemStack itemStack){
        itemStack.set(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get(), itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()).intValue() + 1);
        itemStack.set(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get(), itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()).floatValue() - 1.0f);
    }
    ...
    private void removeOneorTen(ItemStack itemStack, Player player, int amount){
        if(itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()) != null && itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()).intValue() >= amount){
            player.giveExperienceLevels(amount);
            itemStack.set(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get(), itemStack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()).intValue() - amount);
        }
    ...
    public boolean isFoil(ItemStack stack) {
        return stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_LEVEL.get()) != null || stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()) != null;
    }
    ...
    public boolean isBarVisible(ItemStack stack) {
        if(stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()) != null){
            if(stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()).floatValue() > 0.0f){
                return true;
            }
            return false;
        }
    ...
    public int getBarWidth(ItemStack stack) {
      if(stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()) != null) {
          return Math.round(stack.get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()).floatValue() * 10);
      }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if(stack.getComponents().get(ModDataComponentTypesNeoForge.XP_CRYSTAL_PROGRESS.get()) != null){
