...
public class JEI_GrindingCatagory_NeoForge implements IRecipeCategory<RecipeHolder<GrinderRecipe>> {
    ...
    public JEI_GrindingCatagory_NeoForge(IGuiHelper helper) {
