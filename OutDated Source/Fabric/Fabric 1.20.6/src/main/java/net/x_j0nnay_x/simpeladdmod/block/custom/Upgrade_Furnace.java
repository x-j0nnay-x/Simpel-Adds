...
public class Upgrade_Furnace extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<Upgrade_Furnace> CODEC = createCodec(Upgrade_Furnace::new);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        ...
        if ((blockEntity = world.getBlockEntity(pos)) instanceof Upgrade_Furnace_BlockEntity) {
