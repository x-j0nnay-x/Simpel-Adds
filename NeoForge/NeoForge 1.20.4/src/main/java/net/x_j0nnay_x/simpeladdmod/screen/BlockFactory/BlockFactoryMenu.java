...
public class BlockFactoryMenu extends AbstractContainerMenu {
    ...
    public BlockFactoryMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(Capabilities.ItemHandler.ITEM(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, BlockFactoryBlockEntity.GRAVALSLOT, 70, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, BlockFactoryBlockEntity.SANDSLOT, 88, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, BlockFactoryBlockEntity.OBSIDIANSLOT, 106, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.BLOCK_FACTORY.get());
    }
