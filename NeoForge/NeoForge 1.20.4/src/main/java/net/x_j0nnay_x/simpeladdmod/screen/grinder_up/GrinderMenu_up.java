...
public class GrinderMenu_up extends AbstractContainerMenu {
    ...
    public GrinderMenu_up(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(Capabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.INPUTSLOT1, 43, 17){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(ModTags.Items.CANGRIND);
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.INPUTSLOT2, 61, 17){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(ModTags.Items.CANGRIND);
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.INPUTSLOT3, 79, 17){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(ModTags.Items.CANGRIND);
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.INPUTSLOT4, 97, 17){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(ModTags.Items.CANGRIND);
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.OUTPUTSLOT1, 43, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.OUTPUTSLOT2, 61, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.OUTPUTSLOT3, 79, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.OUTPUTSLOT4, 97, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.GRINDERSLOT, 16, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return ModItems.GRINDERHEAD.get() == stack.getItem();
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.UPGRADESLOT, 144, 12){
                @Override
                public boolean mayPlace(ItemStack stack) {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, GrinderBlockEntity_upgrade.BOOSTSLOT, 124, 13){
                @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.GRINDER_BLOCK_UP.get());
    }
