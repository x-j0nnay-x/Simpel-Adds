...
public class GrinderScreen_up extends AbstractContainerScreen<GrinderMenu_up> {
    private static final ResourceLocation texture = new ResourceLocation(Simpeladd.MOD_ID, "textures/screens/grinder_gui_upgrade.png");
    public GrinderScreen_up(GrinderMenu_up pMenu, Inventory pPlayerInventory, Component pTitle) {
