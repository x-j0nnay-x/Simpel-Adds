...
public class GrinderRecipe implements Recipe<SimpleInventory> {
    private final ItemStack output;
    private final List<Ingredient> recipeItems;

    public GrinderRecipe(List<Ingredient> ingredients, ItemStack itemStack) {
    ...
    public boolean matches(SimpleInventory inventory, World world) {
        ...
        return recipeItems.get(0).test(inventory.getStack(GrinderBlockEntity.INPUTSLOT));
    }
    ...
    public static class Serializer implements RecipeSerializer<GrinderRecipe> {
        ...
        private static Codec<List<Ingredient>> validateAmount(Codec<Ingredient> delegate, int max) {
            return Codecs.JSON_ELEMENT.fieldOf(Codecs.JSON_ELEMENT.fieldOf(
        ...
        @Override
        public GrinderRecipe read(PacketByteBuf buf) {
