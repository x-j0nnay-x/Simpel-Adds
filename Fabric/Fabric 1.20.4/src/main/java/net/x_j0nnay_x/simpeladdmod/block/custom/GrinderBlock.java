...
public class GrinderBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public GrinderBlock(Settings pProperties) {
        super(pProperties);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        ...
        if (itemStack.hasCustomName() && (blockEntity = world.getBlockEntity(pos)) instanceof GrinderBlockEntity) {
            ((GrinderBlockEntity)blockEntity).getDisplayName();
        }
    }
    @Override
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.GRINDER,
