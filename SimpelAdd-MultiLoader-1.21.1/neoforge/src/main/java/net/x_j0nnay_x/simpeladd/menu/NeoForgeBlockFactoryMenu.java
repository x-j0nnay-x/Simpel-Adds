...
public class NeoForgeBlockFactoryMenu extends AbstractContainerMenu {
    ...
    public NeoForgeBlockFactoryMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        blockEntity = ((NeoForgeBlockFactoryBlockEntity) entity);
        ...
        addPlayerHotbar(inv);
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeBlockFactoryBlockEntity.WATERSLOT, 34, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                   return Items.WATER_BUCKET == stack.getItem();
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeBlockFactoryBlockEntity.COBBLESLOT, 52, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeBlockFactoryBlockEntity.GRAVALSLOT, 70, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeBlockFactoryBlockEntity.SANDSLOT, 88, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeBlockFactoryBlockEntity.OBSIDIANSLOT, 106, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
