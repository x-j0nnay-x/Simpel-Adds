...
public class ChillerBlockGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ChillerBlockGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ModMenus.CHILLER_BLOCK_GUI.get(), id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, OUTPUT_SLOT, 133, 26) {
