...
public class ForgeChillerMenu extends AbstractContainerMenu {
    ...
    public ForgeChillerMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        addPlayerHotbar(inv);
        this.addSlot(new Slot(this.inventory, ForgeChillerBlockEntity.CHILLINGSLOT, 16, 53){
            @Override
            public boolean mayPlace(ItemStack stack) {
                return stack.is(ModTags.Items.CHILLING);
            }
        });
        this.addSlot(new Slot(this.inventory, ForgeChillerBlockEntity.OUTPUTSLOT, 133, 26){
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
        });
        this.addSlot(new Slot(this.inventory, ForgeChillerBlockEntity.WATERSLOT, 52, 53){
            @Override
            public boolean mayPlace(ItemStack stack){
