...
public class ForgeToolRepairMenu extends AbstractContainerMenu {

    public final ForgeToolRepairBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ForgeToolRepairMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ForgeToolRepairMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypeForge.TOOL_REPAIR_MENU.get(), pContainerID);
        checkContainerSize(inv, 2);
        blockEntity = ((ForgeToolRepairBlockEntity) entity);
    ...
    public ForgeToolRepairBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlockRegForge.TOOLREPAIR.get());
    }
