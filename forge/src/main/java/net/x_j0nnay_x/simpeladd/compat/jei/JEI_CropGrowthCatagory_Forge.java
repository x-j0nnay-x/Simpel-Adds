...
public class JEI_CropGrowthCatagory_Forge implements IRecipeCategory<RecipeHolder<CropGrowthRecipe>> {
    ...
    public JEI_CropGrowthCatagory_Forge(IGuiHelper helper) {
        this.title = Component.translatable("simpeladdmod.jei.crop_growth");
        this.background = helper.createDrawable(TEXTURE, 0, 0, width, height);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlockRegForge.CROP_GROWTH.get()));
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<CropGrowthRecipe> recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.CATALYST, 10, 26).addItemStack(new ItemStack(Items.DIRT));
