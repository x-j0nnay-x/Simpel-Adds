...
public class ForgeGrinderBlockEntity extends Abst_GrinderBlockEntity {
    private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());
    public ForgeGrinderBlockEntity(BlockPos $$1, BlockState $$2) {
        super(ModBlockEntitiesForge.GRINDER.get(), $$1, $$2);
    }
    @Override
    ...
    protected AbstractContainerMenu createMenu(int i, Inventory inventory) {
        return new ForgeGrinderMenu(i, inventory, this, this.data);
    }
