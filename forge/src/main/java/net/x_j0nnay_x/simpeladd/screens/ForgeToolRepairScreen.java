...
public class ForgeToolRepairScreen extends AbstractContainerScreen<ForgeToolRepairMenu> {
    ...
    public ForgeToolRepairScreen(ForgeToolRepairMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
