...
public class ForgeCropGrowthScreen extends AbstractContainerScreen<ForgeCropGrowthMenu> {
    ...
    public ForgeCropGrowthScreen(ForgeCropGrowthMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
