...
import net.x_j0nnay_x.simpeladd.screens.FluidContainerSlot;
...
public class ForgeBlockFactoryMenu extends AbstractContainerMenu {
    ...
    public ForgeBlockFactoryMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, ForgeBlockFactoryBlockEntity.GRINDERSLOT, 79, 8){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return ModItemRegForge.GRINDERHEAD.get() == stack.getItem();
                }
            });
            this.addSlot(new FluidContainerSlot(iItemHandler, ForgeBlockFactoryBlockEntity.LAVASLOT, 124, 53){
                @Override
            ...
            this.addSlot(new FluidContainerSlot(iItemHandler, ForgeBlockFactoryBlockEntity.WATERSLOT, 34, 53){
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, ForgeBlockFactoryBlockEntity.COBBLESLOT, 52, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, ForgeBlockFactoryBlockEntity.GRAVALSLOT, 70, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, ForgeBlockFactoryBlockEntity.SANDSLOT, 88, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(iItemHandler, ForgeBlockFactoryBlockEntity.OBSIDIANSLOT, 106, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
