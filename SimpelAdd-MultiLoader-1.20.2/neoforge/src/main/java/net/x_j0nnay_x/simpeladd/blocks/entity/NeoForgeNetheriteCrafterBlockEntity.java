...
public class NeoForgeNetheriteCrafterBlockEntity extends Abst_NetheriteCrafterBlockEntity {
    ...
    public NeoForgeNetheriteCrafterBlockEntity(BlockPos $$1, BlockState $$2) {
        super(ModBlockEntitiesNeoForge.NETHERITE_CRAFTER.get(), $$1, $$2);
    }

    @Override
    protected AbstractContainerMenu createMenu(int i, Inventory inventory) {
        return new NeoForgeNetheriteCrafterMenu(i, inventory, this, this.data);
    }
