...
public class FabricHarvesterScreen extends AbstractContainerScreen<FabricHarvesterMenu> {
    ...
    public FabricHarvesterScreen(FabricHarvesterMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
