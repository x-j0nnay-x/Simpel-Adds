...
public class FabricCropGrowthScreen extends AbstractContainerScreen<FabricCropGrowthMenu> {
    ...
    public FabricCropGrowthScreen(FabricCropGrowthMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
