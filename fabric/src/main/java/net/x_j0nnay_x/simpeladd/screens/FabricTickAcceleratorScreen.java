...
public class FabricTickAcceleratorScreen extends AbstractContainerScreen<FabricTickAcceleratorMenu> {

    private static final ResourceLocation texture = new ResourceLocation(SimpelAddMod.MOD_ID, "textures/screens/tick_accelerator_gui.png");

    public FabricTickAcceleratorScreen(FabricTickAcceleratorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
