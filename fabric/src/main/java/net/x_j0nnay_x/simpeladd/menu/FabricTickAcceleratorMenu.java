...
public class FabricTickAcceleratorMenu extends AbstractContainerMenu {
    ...
    public  final FabricTickAcceleratorBlockEntity blockEntity;
    private final Level level;
    private final Container inventory;
    private final ContainerData data;

    public FabricTickAcceleratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData){
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(6));}

    public FabricTickAcceleratorMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypeFabric.TICK_ACCELERATOR_MENU, pContainerID);
        checkContainerSize(inv, 3);
        blockEntity = ((FabricTickAcceleratorBlockEntity) entity);
    ...
    public FabricTickAcceleratorBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlockRegFabric.TICK_ACCELERATOR);
    }
