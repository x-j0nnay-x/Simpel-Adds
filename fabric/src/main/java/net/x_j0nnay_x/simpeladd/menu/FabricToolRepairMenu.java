...
public class FabricToolRepairMenu extends AbstractContainerMenu {
    ...
    public  final FabricToolRepairBlockEntity blockEntity;
    private final Level level;
    private final Container inventory;
    private final ContainerData data;

    public FabricToolRepairMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData){
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));}

    public FabricToolRepairMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypeFabric.TOOLREPAIR_MENU, pContainerID);
        checkContainerSize(inv, 2);
        blockEntity = ((FabricToolRepairBlockEntity) entity);
    ...
    public FabricToolRepairBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlockRegFabric.TOOLREPAIR);
    }
