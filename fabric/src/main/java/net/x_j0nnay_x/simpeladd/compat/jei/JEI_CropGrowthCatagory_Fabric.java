...
public class JEI_CropGrowthCatagory_Fabric implements IRecipeCategory<RecipeHolder<CropGrowthRecipe>> {
    ...
    public JEI_CropGrowthCatagory_Fabric(IGuiHelper helper) {
        this.title = Component.translatable("simpeladdmod.jei.crop_growth");
        this.background = helper.createDrawable(TEXTURE, 0, 0, width, height);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlockRegFabric.CROP_GROWTH));
    }
