...
public class JEI_PluginSimpeladd_Fabric implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        registration.addRecipeCategories(new JEI_GrindingCatagory_Fabric(registration.getJeiHelpers().getGuiHelper()));
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(ModBlockRegFabric.GRINDER_BLOCK, JEI_GrindingCatagory_Fabric.GRINDER_RECIPE_RECIPE_TYPE);
        registration.addRecipeCatalyst(ModBlockRegFabric.GRINDER_BLOCK_UP, JEI_GrindingCatagory_Fabric.GRINDER_RECIPE_RECIPE_TYPE);
        registration.addRecipeCatalyst(ModBlockRegFabric.GRIND_FACTORY_BLOCK, JEI_GrindingCatagory_Fabric.GRINDER_RECIPE_RECIPE_TYPE);
    }
