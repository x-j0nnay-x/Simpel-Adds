...
public class BlockFactoryLavaLevelProcedure {
	...
	public static boolean level2(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "LavaLevel") >= 2) {
			return true;
		}
		return false;
	}
	public static boolean level3(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "LavaLevel") >= 3) {
			return true;
		}
		return false;
	}
	public static boolean level4(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "LavaLevel") >= 4) {
			return true;
		}
		return false;
	}
	public static boolean level5(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "LavaLevel") >= 5) {
			return true;
		}
		return false;
	}
