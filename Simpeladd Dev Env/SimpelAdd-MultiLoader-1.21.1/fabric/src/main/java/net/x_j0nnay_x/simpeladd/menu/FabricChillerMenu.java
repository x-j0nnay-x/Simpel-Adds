...
public class FabricChillerMenu extends AbstractContainerMenu {
    ...
    public FabricChillerMenu(int pContainerID, Inventory inv, Container chiller, ContainerData data){
        ...
        addPlayerHotbar(inv);
            this.addSlot(new Slot(this.inventory, FabricChillerBlockEntity.CHILLINGSLOT, 16, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(ModTags.Items.CHILLING);
                }
            });
            this.addSlot(new Slot(this.inventory, FabricChillerBlockEntity.OUTPUTSLOT, 133, 26){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, FabricChillerBlockEntity.WATERSLOT, 52, 53){
                @Override
                public boolean mayPlace(ItemStack stack){
