...
public class ModItemRegForge {
    ...
    public static final RegistryObject<Item> GRINDERHEADNETHERITE = ITEMS.register("grinderhead_netherite", () -> ModItems.GRINDERHEADNEHTERITE);
    ...
    public static final RegistryObject<Item> XPBOOSTUPGRADE = ITEMS.register("xpboostupgrade", () -> ModItems.XPBOOSTUPGRADE);
    //sandwiches
