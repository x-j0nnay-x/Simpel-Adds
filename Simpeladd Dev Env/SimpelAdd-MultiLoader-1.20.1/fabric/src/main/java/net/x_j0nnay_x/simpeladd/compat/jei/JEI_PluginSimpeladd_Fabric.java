...
public class JEI_PluginSimpeladd_Fabric extends JEI_PluginSimpeladd_ABST {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(ModBlockRegFabric.GRINDER_BLOCK, JEI_GrindingCatagory.GRINDER_RECIPE_RECIPE_TYPE);
        registration.addRecipeCatalyst(ModBlockRegFabric.GRINDER_BLOCK_UP, JEI_GrindingCatagory.GRINDER_RECIPE_RECIPE_TYPE);
        registration.addRecipeCatalyst(ModBlockRegFabric.GRIND_FACTORY_BLOCK, JEI_GrindingCatagory.GRINDER_RECIPE_RECIPE_TYPE);
    }
