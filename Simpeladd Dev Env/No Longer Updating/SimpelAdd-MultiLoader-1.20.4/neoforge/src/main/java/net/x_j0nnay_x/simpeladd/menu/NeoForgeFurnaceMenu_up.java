...
public class NeoForgeFurnaceMenu_up extends AbstractContainerMenu {
    ...
    public NeoForgeFurnaceMenu_up(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        addPlayerHotbar(inv);
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.OUTPUTSLOT1, 63, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.OUTPUTSLOT2, 81, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.OUTPUTSLOT3, 99, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.OUTPUTSLOT4, 117, 53){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.XPBOTTLESLOT, 144, 60){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.FUELSLOT, 16, 45){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return NeoForgeFurnaceBlockEntity_Up.isFuel(stack);
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeFurnaceBlockEntity_Up.UPGRADESLOT, 144, 12){
                @Override
                public boolean mayPlace(ItemStack stack) {
