...
public class NeoForgeNetheriteCrafterMenu extends AbstractContainerMenu {
    ...
    public NeoForgeNetheriteCrafterMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        blockEntity = ((NeoForgeNetheriteCrafterBlockEntity) entity);
        ...
        addPlayerHotbar(inv);
            ...
            this.addSlot(new Slot(this.inventory, NeoForgeNetheriteCrafterBlockEntity.OUTPUTSLOT, 124, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeNetheriteCrafterBlockEntity.GOLDSLOT, 52, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(Items.GOLD_INGOT);
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeNetheriteCrafterBlockEntity.BLAZESLOT, 79, 35){
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(Items.BLAZE_ROD);
                }
            });
            this.addSlot(new Slot(this.inventory, NeoForgeNetheriteCrafterBlockEntity.UPGRADESLOT, 144, 12){
                @Override
                public boolean mayPlace(ItemStack stack) {
