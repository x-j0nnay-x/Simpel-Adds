...
public class BlockFactoryBlock extends BlockWithEntity implements BlockEntityProvider{
    ...
    public BlockFactoryBlock(Settings pProperties) {
        super(pProperties);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        ...
        if (itemStack.hasCustomName() && (blockEntity = world.getBlockEntity(pos)) instanceof BlockFactoryBlockEntity) {
            ((BlockFactoryBlockEntity)blockEntity).getDisplayName();
        }
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof BlockFactoryBlockEntity) {
                ItemScatterer.spawn(world, pos, (BlockFactoryBlockEntity)blockEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((BlockFactoryBlockEntity) world.getBlockEntity(pos));
   ...
   @Nullable
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.BLOCK_FACTORY,
