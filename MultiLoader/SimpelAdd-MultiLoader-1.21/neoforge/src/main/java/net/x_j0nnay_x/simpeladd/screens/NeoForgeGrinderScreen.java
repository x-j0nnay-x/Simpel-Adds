...
public class NeoForgeGrinderScreen extends AbstractContainerScreen<NeoForgeGrinderMenu> {
    private static final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(SimpelAddModNeoForge.MODID, "textures/screens/grinder_gui.png");
    public NeoForgeGrinderScreen(NeoForgeGrinderMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
