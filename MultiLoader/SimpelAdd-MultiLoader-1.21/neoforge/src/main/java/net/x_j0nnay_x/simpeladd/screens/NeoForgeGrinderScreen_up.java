...
public class NeoForgeGrinderScreen_up extends AbstractContainerScreen<NeoForgeGrinderMenu_up> {
    private static final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(SimpelAddModNeoForge.MODID, "textures/screens/grinder_gui_upgrade.png");
    public NeoForgeGrinderScreen_up(NeoForgeGrinderMenu_up pMenu, Inventory pPlayerInventory, Component pTitle) {
