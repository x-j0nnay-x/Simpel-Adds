...
public class FabricGrinderMenu extends AbstractContainerMenu {
    ...
    public FabricGrinderMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.addSlot(new Slot(this.inventory, FabricGrinderBlockEntity.GRINDERSLOT, 79, 17){
            ...
            @Override
            public boolean mayPlace(ItemStack stack) {
                return stack.is(ModItemRegFabric.GRINDERHEAD);
            }
        });
        this.addSlot(new Slot(this.inventory, FabricGrinderBlockEntity.OUTPUTSLOT, 124, 44){
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
        ...
        this.addSlot(new Slot(this.inventory, FabricGrinderBlockEntity.UPGRADESLOT, 144, 12){
            @Override
            public boolean mayPlace(ItemStack stack) {
        ...
        this.addSlot(new Slot(this.inventory, FabricGrinderBlockEntity.BOOSTSLOT, 124, 13){
            @Override
