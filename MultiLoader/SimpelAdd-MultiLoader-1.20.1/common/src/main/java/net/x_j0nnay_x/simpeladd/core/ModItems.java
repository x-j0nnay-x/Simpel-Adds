...
//obsidian tear
    ...
    public static final Item OBSIDIANSWORD = new SimpelSwordItem(ModToolTiers.OBSIDIANTIER, 3, -2.4f, new Item.Properties().fireResistant());
    public static final Item OBSIDIANPICKAXE = new SimpelPickaxeItem(ModToolTiers.OBSIDIANTIER, 1, -2.8f, new Item.Properties().fireResistant());
    public static final Item OBSIDAINAXE = new SimpelAxeItem(ModToolTiers.OBSIDIANTIER, 5, 3.0f, new Item.Properties().fireResistant());
    public static final Item OBSIDIANSPADE = new SimpelShovelItem(ModToolTiers.OBSIDIANTIER, 1.5f, -3.0f, new Item.Properties().fireResistant());
    public static final Item OBSIDIANHOE = new SimpelHoeItem(ModToolTiers.OBSIDIANTIER, 0, -3.0f, new Item.Properties().fireResistant());
...
//obsidirite tear
    public static final Item OBSIDIRITESWORD = new SimpelSwordItem(ModToolTiers.OBSIDIRITETTIER, 3, -2.4f, new Item.Properties().fireResistant());
    public static final Item OBSIDIRITEPICKAXE = new SimpelPickaxeItem(ModToolTiers.OBSIDIRITETTIER, 1, -2.8f, new Item.Properties().fireResistant());
    public static final Item OBSIDIRITEAXE = new SimpelAxeItem(ModToolTiers.OBSIDIRITETTIER, 5, 3.0f, new Item.Properties().fireResistant());
    public static final Item OBSIDIRITESPADE = new SimpelShovelItem(ModToolTiers.OBSIDIRITETTIER, 1.5f, -3.0f, new Item.Properties().fireResistant());
    public static final Item OBSIDIRITEHOE = new SimpelHoeItem(ModToolTiers.OBSIDIRITETTIER, 0, -3.0f, new Item.Properties().fireResistant());
...
//netherite boosted
    public static final Item UNOBTIANNETHERITESWORD = new SimpelSwordItem(ModToolTiers.UNOBTAINNETHERITETIER, 3, -2.4f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANNETHERITEPICKAXE = new SimpelPickaxeItem(ModToolTiers.UNOBTAINNETHERITETIER, 1, -2.8f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANNETHERITEAXE = new SimpelAxeItem(ModToolTiers.UNOBTAINNETHERITETIER, 5, 3.0f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANNETHERITESPADE = new SimpelShovelItem(ModToolTiers.UNOBTAINNETHERITETIER, 1.5f, -3.0f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANNETHERITEHOE = new SimpelHoeItem(ModToolTiers.UNOBTAINNETHERITETIER, 0, -3.0f, new Item.Properties().fireResistant());
...
//obsidirite boosted
    public static final Item UNOBTIANOBSIDIRITESWORD = new SimpelSwordItem(ModToolTiers.UNOBTIANOBSIDIRITEATIER, 3, -2.4f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANOBSIDIRITEPICKAXE = new SimpelPickaxeItem(ModToolTiers.UNOBTIANOBSIDIRITEATIER, 1, -2.8f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANOBSIDIRITEAXE = new SimpelAxeItem(ModToolTiers.UNOBTIANOBSIDIRITEATIER, 5, 3.0f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANOBSIDIRITESPADE = new SimpelShovelItem(ModToolTiers.UNOBTIANOBSIDIRITEATIER, 1.5f, -3.0f, new Item.Properties().fireResistant());
    public static final Item UNOBTIANOBSIDIRITEHOE = new SimpelHoeItem(ModToolTiers.UNOBTIANOBSIDIRITEATIER, 0, -3.0f, new Item.Properties().fireResistant());
