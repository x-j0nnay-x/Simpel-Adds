...
public class ModBlockRegNeoForge {
    ...
    public static final DeferredBlock<Block> BLOCK_FACTORY = registerBlock("blockfactory_block",
            () -> new NeoForgeBlockFactoryBlock(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion().requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> CHILLER = registerBlock("chiller_block",
            () -> new NeoForgeChillerBlock(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion().requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> GRINDER_BLOCK = registerBlock("grinder_block",
            () -> new NeoForgeGrinderBlock(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion().requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> GRINDER_BLOCK_UP = registerBlock("grinder_block_up",
            () -> new NeoForgeGrinderBlock_Up(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion().requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> NETHERITE_CRAFTER = registerBlock("netherite_crafter_block",
            () -> new NeoForgeNetheriteCraftingBlock(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion().requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> UPGRADED_FURNACE = registerBlock("upgraded_furnace_block",
            () -> new NeoForgeFurnaceBlock_Up(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion().requiresCorrectToolForDrops()));
